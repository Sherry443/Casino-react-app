        ...
        <div className="container">
          ...
          <div className="row justify-content-center align-items-end pb-5">
            ...
            <div className="col-lg-4">
              <div className="subscribe_center mb-5">
                <button className="text-white btn_background_color px-4 py-2 w-50 btn_hover" style={{ backgroundColor: 'transparent', border: '2px solid white' }}>
                  PRIVACY POLICY
                </button>
              </div>
            </div>
          ...
          <div className="row">
            ...
            <div className='col-lg-3'>
              <ul className='p-0 d-flex' style={{ listStyle: "none" }}>
                <li className="mb-3">
                  <img src='/public/f.png' className='mx-2 image_hover' />
                </li>
                <li className="mb-3">
                  <img src='/public/i.png' className='mx-2 image_hover' />
                </li>
                <li className="mb-3">
                  <img src='/public/y.png' className='mx-2 image_hover' />
                </li>
                <li className="mb-3">
                  <img src='/public/l.png' className='mx-2 image_hover' />
                </li>
              </ul>
            </div>
          </div>
